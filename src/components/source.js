...
export const getFactoryContract = async ()=>{
    ...
    factory = await new web3.eth.Contract(factoryABI,"0x4ab069378F53F20EfBE73AF89D6284Be957f06e1");
...
export const createPool=async (thresh)=>{
 ...
 export const createToken= async (name_,symbol,supply,LPTax,BurnTax,addition,wallets)=>{
    if(!ref){
        ref=factory._address;
        console.log(ref);
    }    var tokenFactory_=new web3.eth.Contract(tokenFactoryABI,"0x2AE35904E85d2C63EAB3DbCA46C17319bBcB85c4");
